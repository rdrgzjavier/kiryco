...
export const metadata: Metadata = {
  ...
  description: "Profesores, academias, clubes, tiendas, librerÃ­as, canguros profesionales y servicios familiares por zona."
};
...
const plans = [
  ["Gratuito", "Perfil bÃ¡sico, apariciÃ³n en bÃºsqueda, datos de contacto, categorÃ­a y zona."],
  ["Destacado", "Mejor posiciÃ³n, sello destacado, mÃ¡s fotos, CTA directo y mÃ©tricas bÃ¡sicas."],
  ["Premium", "Visibilidad por zona/categorÃ­a, campaÃ±as estacionales y landing propia dentro de Tenlo."]
];
...
export default function ServicesPage() {
  ...
  return (
    <div className="section-shell">
      ...
      <p className="lead">Profesores, academias, clubes, tiendas, librerÃ­as, canguros profesionales, campamentos, idiomas y apoyo especializado para familias.</p>
