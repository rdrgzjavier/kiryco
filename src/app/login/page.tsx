      ...
      <div className="mx-auto grid max-w-5xl gap-6 lg:grid-cols-[1fr_360px]">
        <div className="rounded-2xl border border-line bg-panel p-5 md:p-8">
          ...
          <form className="mt-6 grid gap-4">
            ...
            <label className="field-label">Tipo de usuario<select className="field"><option>Familia</option><option>Profesional local</option><option>Centro educativo</option><option>Equipo Tenlo</option></select></label>
