...
const heroImage = "https://images.pexels.com/photos/7705912/pexels-photo-7705912.jpeg?auto=compress&cs=tinysrgb&w=1200";
    ...
    <>
      ...
      <section className="page relative z-10 py-14 lg:py-16">
        <div className="mb-5 text-center">
          ...
          <p className="mx-auto mt-3 max-w-4xl text-sm leading-6 text-muted lg:whitespace-nowrap">Accesos rápidos a las categorías que más usan las familias para comparar servicios, centros y recursos locales.</p>
        </div>
      ...
      <section className="page grid gap-8 py-14 lg:grid-cols-[0.72fr_1fr] lg:py-16">
        ...
        <div className="card relative min-h-[360px] overflow-hidden bg-[#F3F2F0] p-0">
          <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.68),rgba(243,242,240,0.88))]" />
          <svg className="absolute inset-0 h-full w-full opacity-90 grayscale" viewBox="0 0 760 420" role="img" aria-label="Mapa en tonos grises del Noroeste de Madrid">
            <rect width="760" height="420" fill="#F4F4F2" />
            <path d="M-20 112 C96 88 168 122 238 102 C326 78 388 10 470 38 C558 68 592 142 780 120" fill="none" stroke="#DBD9D5" strokeWidth="3" />
            <path d="M-10 266 C82 232 164 252 236 214 C326 166 360 152 446 178 C542 208 618 302 784 286" fill="none" stroke="#D5D3CF" strokeWidth="3" />
            <path d="M76 420 C116 318 120 252 178 206 C244 154 276 94 338 -14" fill="none" stroke="#D7D5D1" strokeWidth="3" />
            <path d="M360 430 C396 338 384 276 432 220 C492 150 546 104 574 -10" fill="none" stroke="#DCDAD7" strokeWidth="2" />
            <path d="M218 88 C274 118 306 170 296 222 C284 286 224 328 162 300 C100 272 76 198 104 136 C126 88 174 66 218 88Z" fill="#C9C9CF" fillOpacity="0.72" stroke="#AEB0B8" strokeWidth="3" />
            <path d="M262 184 C310 154 370 166 400 214 C430 262 402 326 340 336 C288 344 250 304 246 252 C244 224 246 198 262 184Z" fill="#D7D7DB" fillOpacity="0.68" stroke="#B9BBC2" strokeWidth="2" />
            <path d="M388 112 C440 92 492 120 508 170 C526 226 486 266 432 254 C380 242 350 188 366 146 C370 132 378 120 388 112Z" fill="#E2E2E4" fillOpacity="0.74" stroke="#C5C6CB" strokeWidth="2" />
            <path d="M402 270 C452 246 512 270 530 326 C548 382 494 420 438 392 C398 372 376 310 402 270Z" fill="#DADADF" fillOpacity="0.72" stroke="#BBBDC4" strokeWidth="2" />
            <g fill="#8D9098">
              <circle cx="180" cy="204" r="5" />
              <circle cx="350" cy="246" r="5" />
              <circle cx="444" cy="178" r="5" />
              <circle cx="458" cy="330" r="5" />
            </g>
          </svg>
          <div className="relative flex min-h-[360px] items-center justify-end p-6 sm:p-8">
            <div className="w-full rounded-3xl bg-white/86 p-5 shadow-soft ring-1 ring-white/70 backdrop-blur sm:w-[260px]">
              <p className="mb-4 text-xs font-bold uppercase tracking-[0.05em] text-muted">Zonas con oferta</p>
