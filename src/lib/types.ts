...
export type Provider = {
  id: string; userId: string; businessName: string; category: string; description: string; municipality: string; serviceArea: string; website: string; phone: string; email: string; verified: boolean; trustLevel: TrustLevel; plan: ProviderPlan; tags: string[]; image?: string;
};
