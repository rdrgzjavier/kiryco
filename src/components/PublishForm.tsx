...
export default function PublishForm() {
  ...
  return (
    <div className="section-shell max-w-4xl">
      ...
      {sent ? (
        <div className="mt-8 rounded-2xl border border-line bg-soft p-5 text-sm font-semibold leading-6 text-slatecopy">Publicación enviada a revisión. Estado: pendiente de revisión.</div>
      ) : (
