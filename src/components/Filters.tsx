  ...
  return (
    <aside className="card h-fit p-5">
      ...
      <div className="mt-5 grid gap-4">
        ...
        <label className="field-label">Edad recomendada<select className="field"><option>Todas</option><option>1-3 años</option><option>3-6 años</option><option>6-12 años</option><option>12-18 años</option></select></label>
        ...
        <label className="field-label">Tipo<select className="field"><option>Todos</option><option>Familia</option><option>Proveedor</option><option>Centro</option></select></label>
